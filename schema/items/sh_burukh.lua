ITEM.name = "Burukh Cocktail"
ITEM.desc = "A cocktail imported from the Krogan DMZ. Best if served after being lit on fire, just like krogan enjoy doing to everything else."
