ITEM.name = "Frozen Pyjak"
ITEM.desc = "Heavily intoxicating, hardly flavored drink made from the spills of other drinks. Known to knock people out and leave terrible hangovers."
